...
Public Class ExportExcel
    ...
    Private Sub Export_with_XSLT_Windows(ByVal dsExport As DataSet, ByVal sHeaders As String(), ByVal sFileds As String(), ByVal FormatType As ExportFormat, ByVal FileName As String, Optional ByVal Path As String = "")
        Try
            ...
            If Path.Trim.Length = 0 Then
                strPath = System.Configuration.ConfigurationSettings.AppSettings("LogPath").Trim
            Else
                strPath = Path.Trim
            End If

            Dim writer3 As New StreamWriter(strPath + "\" & FileName)
    ...
    Public Sub ExportDetails(ByVal objXml As XmlDocument, ByVal strTableName As String, ByVal FormatType As ExportFormat, ByVal FileName As String, Optional ByVal Path As String = "")
        Try
            ...
            ElseIf (Me.appType = "Win") Then
                Me.Export_with_XSLT_Windows(dsExport, sHeaders, sFileds, FormatType, FileName, Path)
            End If
        Catch exception As Exception
            Throw exception
        End Try
    ...
    Public Sub ExportDetails(ByVal DetailsTable As DataTable, ByVal FormatType As ExportFormat, ByVal FileName As String, Optional ByVal Path As String = "")
        Try
            If (DetailsTable.Rows.Count = 0) Then
                Throw New Exception("There are no details to export.")
            End If
    ...
    Public Sub ExportDetails(ByVal DetailsTable As DataTable, ByVal ColumnList As Integer(), ByVal FormatType As ExportFormat, ByVal FileName As String, Optional ByVal Path As String = "")
        Try
            If (DetailsTable.Rows.Count = 0) Then
                Throw New Exception("There are no details to export")
            End If
    ...
    Public Sub ExportDetails(ByVal objXml As XmlDocument, ByVal strTableName As String, ByVal ColumnList As Integer(), ByVal Headers As String(), ByVal FormatType As ExportFormat, ByVal FileName As String, Optional ByVal Path As String = "")
        Try
            Dim DetailsTable As New DataTable
            DetailsTable = ConvertXmlToDataTable(objXml, strTableName)
            If (DetailsTable.Rows.Count = 0) Then
            ...
            ElseIf (Me.appType = "Win") Then
                Me.Export_with_XSLT_Windows(dsExport, Headers, sFileds, FormatType, FileName, Path)
            End If
        Catch exception As Exception
            Throw exception
        End Try
    ...
    Public Sub ExportDetails(ByVal objXml As XmlDocument, ByVal strTableName As String, ByVal ColumnList As ArrayList, ByVal Headers As ArrayList, ByVal FormatType As ExportFormat, ByVal FileName As String, Optional ByVal Path As String = "")
        Try
    ...
    Public Sub ExportDetails(ByVal DetailsTable As DataTable, ByVal ColumnList As Integer(), ByVal Headers As String(), ByVal FormatType As ExportFormat, ByVal FileName As String, Optional ByVal Path As String = "")
        Try
            If (DetailsTable.Rows.Count = 0) Then
                Throw New Exception("There are no details to export")
            End If
